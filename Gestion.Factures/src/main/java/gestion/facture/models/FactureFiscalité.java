...
public class FactureFiscalité extends Facture{
	...
	public FactureFiscalité(Long id,String f, int bordereau, String devise, double montant, String objet, String num_po,
	...
	public FactureFiscalité(Long id) {
		this.id=id;
	}
	public FactureFiscalité() {
